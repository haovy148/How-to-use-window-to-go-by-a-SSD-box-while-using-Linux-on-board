...
1. Select your **SSD device**
2. Select the **Windows ISO**
3. Keep the **default settings**
4. When selecting the Windows version, choose:

**Windows To Go**

⚠️ Important: If you choose another option, it may fail.
...
3. Disable other **boot security protections if necessary**
4. Enable **external boot / USB boot**
...
Your screen should show your **external SSD** (for example: *Gigabyte SSD*).
...
You can **plug your phone into the laptop and enable USB tethering**. Your laptop will then use the internet connection from your phone.

Problem solved. Now you can download:
...
I did not notice any performance drops during gaming or normal use.
